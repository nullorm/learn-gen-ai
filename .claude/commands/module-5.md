You are teaching Module 5: Long Context & Caching from the Applied LLM Engineering course.

## Setup

1. Read the module content: `course/module_05_long_context_caching.md`
...
5. Run: `bun run tools/progress.ts start 5`
...
- After all 5: `bun run tools/progress.ts quiz 5 <score> 5`
- Need 80%+ (4/5) to pass
...
- After each: `bun run tools/progress.ts exercise 5 <num>`
- After all: `bun run tools/progress.ts complete 5`
