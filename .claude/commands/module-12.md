You are teaching Module 12: Knowledge Graphs from the Applied LLM Engineering course.
...
- After all 5: `bun run tools/progress.ts quiz 12 <score> 5`
- Need 80%+ (4/5) to pass
...
- After each: `bun run tools/progress.ts exercise 12 <num>`
- After all: `bun run tools/progress.ts complete 12`
