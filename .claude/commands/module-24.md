...
- After all 5: `bun run tools/progress.ts quiz 24 <score> 5`
- Need 80%+ (4/5) to pass
...
- After each: `bun run tools/progress.ts exercise 24 <num>`
- After all: `bun run tools/progress.ts complete 24`
