...
5. Run: `bun run tools/progress.ts start 14`
...
- After all 5: `bun run tools/progress.ts quiz 14 <score> 5`
- Need 80%+ (4/5) to pass
...
- After each: `bun run tools/progress.ts exercise 14 <num>`
- After all: `bun run tools/progress.ts complete 14`
